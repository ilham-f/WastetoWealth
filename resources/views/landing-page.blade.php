...
<body id="page-top">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                    <li class="nav-item"><a class="nav-link"style="font-weight:bold;" href="#services">Donation</a></li>
                    <li class="nav-item"><a class="nav-link" style="font-weight:bold;"href="#portfolio">Campaign</a></li>
                    <li class="nav-item"><a class="nav-link" style="font-weight:bold;"href="#portfolio">Send Trash</a></li>
                    <li class="nav-item"><a class="nav-link" style="font-weight:bold;"href="#about">About</a></li>
                    <li class="nav-item"><a class="nav-link" style="font-weight:bold;"href="#contact">Contact</a></li>
                </ul>
            </div>
            <button type="button" class="btn waves-effect waves-light btn-rounded btn-primary"
                style="margin-left:20px; width:max-content;letter-spacing:2px;">LOGIN</button>
        </div>
    </nav>
    <!-- Masthead-->
    <header class="masthead">
        <div class="container">
            <div class="masthead-subheading">Welcome to Our Dashboard</div>
    ...
    <section class="page-section" id="services">
        <div class="container">
            <div class="text-center">
                <h2 class="section-heading text-uppercase">Donations</h2>
                <br>
    ...
    <section class="page-section" id="about">
        <div class="container">
            <div class="text-center">
                <h2 class="section-heading text-uppercase">Trash Flow</h2>
                <h3 class="section-subheading text-muted">How your trash will be processed</h3>
            </div>
            <ul class="timeline">
                <li>
                    ...
                    <div class="timeline-panel">
                        ...
                        <div class="timeline-body">
                            <p class="text-muted">Contact us using our features that available on your dashboard. We will pick up your trash immediately.</p>
                        </div>
                    </div>
                </li>
                <li class="timeline-inverted">
                    ...
                    <div class="timeline-panel">
                        <div class="timeline-heading">
                            <h4>Taking The Trash To Nearby Bank Sampah</h4>
                            {{-- <h4 class="subheading">An Agency is Born</h4> --}}
                        </div>
                        <div class="timeline-body">
                            <p class="text-muted">We will taking your trash to nearby Bank Sampah. Your trash will be immediately recorded in the system which can be seen through your account.
                        </div>
                    </div>
                </li>
                <li>
                    ...
                    <div class="timeline-panel">
                        <div class="timeline-heading">
                            <h4>Trash Proccessed</h4>
                            {{-- <h4 class="subheading">Transition to Full Service</h4> --}}
                        </div>
                        <div class="timeline-body">
                            <p class="text-muted">Your trash will be processed into goods that have potential resources.</p>
                        </div>
                    </div>
                </li>
                <li class="timeline-inverted">
                    ...
                    <div class="timeline-panel">
                        ...
                        <div class="timeline-body">
                            <p class="text-muted">After processing, your waste will be continued as donation in the form of finished goods that will be sent to various places.</p>
                        </div>
                    </div>
                </li>
                <li class="timeline-inverted">
